...
##Analisis Marge Sort##
# Untuk Merge Sort, baik dalam kasus terburuk, rata-rata, maupun terbaik, kompleksitas 
...
##Analisis Quick Sort##
#Quick Sort menunjukkan karakteristik yang berbeda. Dalam kasus terburuk, yang biasanya terjadi ketika 
...
#dengan kompleksitas O(n) pada setiap langkah. Namun, dalam kasus rata-rata, di mana pivot biasanya membagi 
#daftar menjadi dua bagian yang lebih seimbang, Quick Sort memiliki kompleksitas O(n log n), mirip dengan Merge Sort. 
#Kasus terbaik juga memiliki kompleksitas O(n log n) jika pivot membagi daftar secara optimal.meskipun 
